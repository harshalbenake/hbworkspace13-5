...
package com.elitetechnologies.draganddropboard;
...
public class BoardFragment extends Fragment {
    ...
    private void addColumn() {
        ...
        ((TextView) header.findViewById(R.id.text)).setText("Column " + (mColumns + 1) +" (Add Item)");
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((TextView) header.findViewById(R.id.item_count)).setText("Row Items: "+String.valueOf(mItemArray.size()));
            }
        });
